...
// MARK: Components
// MARK: Shaders
import vertexShader from "shaders/spotLight/vertex.glsl";
import fragmentShader from "shaders/spotLight/fragment.glsl";
// MARK: Functionality
// MARK: Utils
...
const Scene = ({}: Props) => {
  ...
  const spotLight: SpotLight = {
    ...
    direction: new THREE.Vector3(0, 1.0, 23.14),
    cutOff: 0
  }
